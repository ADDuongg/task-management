...
import { filterInterface, sortInterface, UsersInterface } from "@/types";
import { deleteApiResponse, UsersResponse } from "@/types/api";
...
export const userServices = {
    getListUsers: async ({
        ...
        const res = await requests.post<UsersResponse, any>(`/user?action=get&${queryParams.toString()}`, body, true);
        return res;
    },
